  ...
  <body>
    ...
    <div class="row main-cont container-fluid">
      ...
      <div class="col container">
        ...
        echo "  <div class='panel-heading'> <?php  LOGIN:$msg?> </div>";
         ?>
...
?>
          ...
          <div class="mb-3 forgot-password"><a href='forget_password.php'>Forgot password?</a></div>
            <div class="mb-3">
            <input type="submit" name="login" value="Login" class="btn btn-primary w-100 text-center"></input>
            <div class="mb-3 no-account"><a href='register.php'>Don't have a account?</a></div>
          </div>
            </div>
        </form>
        </div>
